...
向了解更多有关优化共享池内容可参考 [tuning shared pool](https://docs.oracle.com/en/database/oracle/oracle-database/12.2/tgdba/tuning-shared-pool-and-large-pool.html#GUID-2EB3A7A0-881D-42AA-A299-DD118FF2BB92) 。
